...
import 'package:haus_kafein/pages/splash_screen/splash_screen2.dart';
import 'package:haus_kafein/theme.dart';

class Splash_Screen_1 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Image.asset(
            'assets/images/images_splash_1.png',
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: RichText(
                    text: TextSpan(
                      text: 'Lebih mudah menemukan coffee shop',
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: '\ndisekitarmu',
                          style: textstyle_Title_CLash_Splash,
                        ),
                      ],
                    ),
                  ),
                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => Splash_Screen_2(),
                      ),
                    );
                  },
                  child: Container(
